...
//=============================================================================
  ...
  TH1D *hStrEvent = new TH1D("hStrEvent", "", 100, 0., 100.); hStrEvent->Sumw2(); list->Add(hStrEvent);
//=============================================================================
 TString BeforPara[31];
  TString AfterPara[31];
  BeforPara[ 0] = "BeforeV0Radius";
  BeforPara[ 1] = "BeforeV0CosPA";
  BeforPara[ 2] = "BeforeV0DistToPVoverP";
  BeforPara[ 3] = "BeforeV0DausDCA";
  BeforPara[ 4] = "BeforePosDCAtoPV";
  BeforPara[ 5] = "BeforeNegDCAtoPV";
  BeforPara[ 6] = "BeforeDauXrowsTPC";
  BeforPara[ 7] = "BeforeDauXrowsOverFindableClusTPC";
  BeforPara[ 8] = "BeforePosPionSigmaTPC";
  BeforPara[ 9] = "BeforeNegPionSigmaTPC";
  BeforPara[10] = "BeforePosProtonSigmaTPC";
  BeforPara[11] = "BeforeNegProtonSigmaTPC";
  BeforPara[12] = "BeforeV0Pt";
  BeforPara[13] = "BeforeRapidityKa";
  BeforPara[14] = "BeforeRapidityLa";
  BeforPara[15] = "BeforeKshortMass";
  BeforPara[16] = "BeforeLambdaMass";
  BeforPara[17] = "BeforeAntiLaMass";
  BeforPara[18] = "BeforePosEta";
  BeforPara[19] = "BeforeNegEta";
  BeforPara[20] = "BeforeXiRadius";
  BeforPara[21] = "BeforeXiCosPA";
  BeforPara[22] = "BeforeXiDCAtoPV";
  BeforPara[23] = "BeforeV0DCAtoPV";
  BeforPara[24] = "BeforeV0toBachDCA";
  BeforPara[25] = "BeforeBachDCAtoPV";
  BeforPara[26] = "BeforeBachXrowsTPC";
  BeforPara[27] = "BeforeBachXrowsOverFindableClusTPC";
  BeforPara[28] = "BeforeBachEta";
  BeforPara[29] = "BeforeBachPiSigmaTPC";
  BeforPara[30] = "BeforeBachKaSigmaTPC";

  AfterPara[ 0] = "AfterV0Radius";
  AfterPara[ 1] = "AfterV0CosPA";
  AfterPara[ 2] = "AfterV0DistToPVoverP";
  AfterPara[ 3] = "AfterV0DausDCA";
  AfterPara[ 4] = "AfterPosDCAtoPV";
  AfterPara[ 5] = "AfterNegDCAtoPV";
  AfterPara[ 6] = "AfterDauXrowsTPC";
  AfterPara[ 7] = "AfterDauXrowsOverFindableClusTPC";
  AfterPara[ 8] = "AfterPosPionSigmaTPC";
  AfterPara[ 9] = "AfterNegPionSigmaTPC";
  AfterPara[10] = "AfterPosProtonSigmaTPC";
  AfterPara[11] = "AfterNegProtonSigmaTPC";
  AfterPara[12] = "AfterV0Pt";
  AfterPara[13] = "AfterRapidityKa";
  AfterPara[14] = "AfterRapidityLa";
  AfterPara[15] = "AfterKshortMass";
  AfterPara[16] = "AfterLambdaMass";
  AfterPara[17] = "AfterAntiLaMass";
  AfterPara[18] = "AfterPosEta";
  AfterPara[19] = "AfterNegEta";
  AfterPara[20] = "AfterXiRadius";
  AfterPara[21] = "AfterXiCosPA";
  AfterPara[22] = "AfterXiDCAtoPV";
  AfterPara[23] = "AfterV0DCAtoPV";
  AfterPara[24] = "AfterV0toBachDCA";
  AfterPara[25] = "AfterBachDCAtoPV";
  AfterPara[26] = "AfterBachXrowsTPC";
  AfterPara[27] = "AfterBachXrowsOverFindableClusTPC";
  AfterPara[28] = "AfterBachEta";
  AfterPara[29] = "AfterBachPiSigmaTPC";
  AfterPara[30] = "AfterBachKaSigmaTPC";
 
  TH1D *BeforeV0Radius = new TH1D(BeforPara[ 0], "", 200, 0., 20);
  TH1D *BeforeV0CosPA = new TH1D(BeforPara[ 1], "", 100, 0.9, 1);
  TH1D *BeforeV0DistToPVoverP = new TH1D(BeforPara[ 2], "", 100, 0., 50.);
  TH1D *BeforeV0DausDCA = new TH1D(BeforPara[ 3], "", 100, 0., 10.);
  TH1D *BeforePosDCAtoPV = new TH1D(BeforPara[ 4], "", 1000, 0., 10.);
  TH1D *BeforeNegDCAtoPV = new TH1D(BeforPara[ 5], "", 1000, 0., 10.);
  TH1D *BeforeDauXrowsTPC = new TH1D(BeforPara[ 6], "", 100, 0., 100);
  TH1D *BeforeDauXrowsOverFindableClusTPC = new TH1D(BeforPara[ 7], "", 100, 0. , 1.);
  TH1D *BeforePosPionSigmaTPC = new TH1D(BeforPara[ 8], "", 100, 0. , 10.);
  TH1D *BeforeNegPionSigmaTPC = new TH1D(BeforPara[ 9], "", 100, 0. , 10.);
  TH1D *BeforePosProtonSigmaTPC = new TH1D(BeforPara[10], "", 100, 0. , 10.);
  TH1D *BeforeNegProtonSigmaTPC = new TH1D(BeforPara[11], "", 100, 0. , 10.);
  TH1D *BeforeV0Pt = new TH1D(BeforPara[12], "", 100, 0. , 13);
  TH1D *BeforeRapidityKa = new TH1D(BeforPara[13], "", 100, -0.5, 0.5);
  TH1D *BeforeRapidityLa = new TH1D(BeforPara[14], "", 100, -0.5, 0.5);
  TH1D *BeforeKshortMass = new TH1D(BeforPara[15], "", 100, 0, 10);
  TH1D *BeforeLambdaMass = new TH1D(BeforPara[16], "", 1000, 1, 2);
  TH1D *BeforeAntiLaMass = new TH1D(BeforPara[17], "", 1000, 1, 2);
  TH1D *BeforePosEta = new TH1D(BeforPara[18], "", 100, -1., 1.);
  TH1D *BeforeNegEta = new TH1D(BeforPara[19], "", 100, -1., 1.);
  TH1D *BeforeXiRadius = new TH1D(BeforPara[20], "", 100, 0., 10);
  TH1D *BeforeXiCosPA = new TH1D(BeforPara[21], "", 100, 0.9, 1.);
  TH1D *BeforeXiDCAtoPV = new TH1D(BeforPara[22], "", 100, -1000, -990);
  TH1D *BeforeV0DCAtoPV = new TH1D(BeforPara[23], "", 100, 0, 10);
  TH1D *BeforeV0toBachDCA = new TH1D(BeforPara[24], "", 100, 0, 2);
  TH1D *BeforeBachDCAtoPV = new TH1D(BeforPara[25], "", 1000, 0., 10.);
  TH1D *BeforeBachXrowsTPC = new TH1D(BeforPara[26], "", 100, 0., 100.);
  TH1D *BeforeBachXrowsOverFindableClusTPC = new TH1D(BeforPara[27], "", 100, 0., 1.);
  TH1D *BeforeBachEta = new TH1D(BeforPara[28], "", 100, -1., 1.);
  TH1D *BeforeBachPiSigmaTPC = new TH1D(BeforPara[29], "", 100, 0., 10.);
  TH1D *BeforeBachKaSigmaTPC = new TH1D(BeforPara[30], "", 100, 0., 10.);

  list->Add(BeforeV0Radius);
  list->Add(BeforeV0CosPA);
  list->Add(BeforeV0DistToPVoverP);
  list->Add(BeforeV0DausDCA);
  list->Add(BeforePosDCAtoPV);
  list->Add(BeforeNegDCAtoPV);
  list->Add(BeforeDauXrowsTPC);
  list->Add(BeforeDauXrowsOverFindableClusTPC);
  list->Add(BeforePosPionSigmaTPC);
  list->Add(BeforeNegPionSigmaTPC);
  list->Add(BeforePosProtonSigmaTPC);
  list->Add(BeforeNegProtonSigmaTPC);
  list->Add(BeforeV0Pt);
  list->Add(BeforeRapidityKa);
  list->Add(BeforeRapidityLa);
  list->Add(BeforeKshortMass);
  list->Add(BeforeLambdaMass);
  list->Add(BeforeAntiLaMass);
  list->Add(BeforePosEta);
  list->Add(BeforeNegEta);
  list->Add(BeforeXiRadius);
  list->Add(BeforeXiCosPA);
  list->Add(BeforeXiDCAtoPV);
  list->Add(BeforeV0DCAtoPV);
  list->Add(BeforeV0toBachDCA);
  list->Add(BeforeBachDCAtoPV);
  list->Add(BeforeBachXrowsTPC);
  list->Add(BeforeBachXrowsOverFindableClusTPC);
  list->Add(BeforeBachEta);
  list->Add(BeforeBachPiSigmaTPC);
  list->Add(BeforeBachKaSigmaTPC);

  TH1D *AfterV0Radius = new TH1D(AfterPara[ 0], "", 200, 0., 20);
  TH1D *AfterV0CosPA = new TH1D(AfterPara[ 1], "", 100, 0.9, 1);
  TH1D *AfterV0DistToPVoverP = new TH1D(AfterPara[ 2], "", 100, 0., 50.);
  TH1D *AfterV0DausDCA = new TH1D(AfterPara[ 3], "", 100, 0., 10.);
  TH1D *AfterPosDCAtoPV = new TH1D(AfterPara[ 4], "", 1000, 0., 10.);
  TH1D *AfterNegDCAtoPV = new TH1D(AfterPara[ 5], "", 1000, 0., 10.);
  TH1D *AfterDauXrowsTPC = new TH1D(AfterPara[ 6], "", 100, 0., 100);
  TH1D *AfterDauXrowsOverFindableClusTPC = new TH1D(AfterPara[ 7], "", 100, 0. , 1.);
  TH1D *AfterPosPionSigmaTPC = new TH1D(AfterPara[ 8], "", 100, 0. , 10.);
  TH1D *AfterNegPionSigmaTPC = new TH1D(AfterPara[ 9], "", 100, 0. , 10.);
  TH1D *AfterPosProtonSigmaTPC = new TH1D(AfterPara[10], "", 100, 0. , 10.);
  TH1D *AfterNegProtonSigmaTPC = new TH1D(AfterPara[11], "", 100, 0. , 10.);
  TH1D *AfterV0Pt = new TH1D(AfterPara[12], "", 100, 0. , 13);
  TH1D *AfterRapidityKa = new TH1D(AfterPara[13], "", 100, -0.5, 0.5);
  TH1D *AfterRapidityLa = new TH1D(AfterPara[14], "", 100, -0.5, 0.5);
  TH1D *AfterKshortMass = new TH1D(AfterPara[15], "", 100, 0, 10);
  TH1D *AfterLambdaMass = new TH1D(AfterPara[16], "", 1000, 1, 2);
  TH1D *AfterAntiLaMass = new TH1D(AfterPara[17], "", 1000, 1, 2);
  TH1D *AfterPosEta = new TH1D(AfterPara[18], "", 100, -1., 1.);
  TH1D *AfterNegEta = new TH1D(AfterPara[19], "", 100, -1., 1.);
  TH1D *AfterXiRadius = new TH1D(AfterPara[20], "", 100, 0., 10);
  TH1D *AfterXiCosPA = new TH1D(AfterPara[21], "", 100, 0.9, 1.);
  TH1D *AfterXiDCAtoPV = new TH1D(AfterPara[22], "", 100, -1000, -990);
  TH1D *AfterV0DCAtoPV = new TH1D(AfterPara[23], "", 100, 0, 10);
  TH1D *AfterV0toBachDCA = new TH1D(AfterPara[24], "", 100, 0, 2);
  TH1D *AfterBachDCAtoPV = new TH1D(AfterPara[25], "", 1000, 0., 10.);
  TH1D *AfterBachXrowsTPC = new TH1D(AfterPara[26], "", 100, 0., 100.);
  TH1D *AfterBachXrowsOverFindableClusTPC = new TH1D(AfterPara[27], "", 100, 0., 1.);
  TH1D *AfterBachEta = new TH1D(AfterPara[28], "", 100, -1., 1.);
  TH1D *AfterBachPiSigmaTPC = new TH1D(AfterPara[29], "", 100, 0., 10.);
  TH1D *AfterBachKaSigmaTPC = new TH1D(AfterPara[30], "", 100, 0., 10.);

  list->Add(AfterV0Radius);
  list->Add(AfterV0CosPA);
  list->Add(AfterV0DistToPVoverP);
  list->Add(AfterV0DausDCA);
  list->Add(AfterPosDCAtoPV);
  list->Add(AfterNegDCAtoPV);
  list->Add(AfterDauXrowsTPC);
  list->Add(AfterDauXrowsOverFindableClusTPC);
  list->Add(AfterPosPionSigmaTPC);
  list->Add(AfterNegPionSigmaTPC);
  list->Add(AfterPosProtonSigmaTPC);
  list->Add(AfterNegProtonSigmaTPC);
  list->Add(AfterV0Pt);
  list->Add(AfterRapidityKa);
  list->Add(AfterRapidityLa);
  list->Add(AfterKshortMass);
  list->Add(AfterLambdaMass);
  list->Add(AfterAntiLaMass);
  list->Add(AfterPosEta);
  list->Add(AfterNegEta);
  list->Add(AfterXiRadius);
  list->Add(AfterXiCosPA);
  list->Add(AfterXiDCAtoPV);
  list->Add(AfterV0DCAtoPV);
  list->Add(AfterV0toBachDCA);
  list->Add(AfterBachDCAtoPV);
  list->Add(AfterBachXrowsTPC);
  list->Add(AfterBachXrowsOverFindableClusTPC);
  list->Add(AfterBachEta);
  list->Add(AfterBachPiSigmaTPC);
  list->Add(AfterBachKaSigmaTPC);
  ...
  while (fChainRD->GetEntry(iEvent++)) if (InitEvent("P")) {
    ...
    if((sOpt == "Kshort") || (sOpt == "Lambda") || (sOpt == "AntiLa")){
      ...
      for (Int_t i=0; i<nV0s; i++) {
        pV0 = (AliPicoV0RD*)fV0sClArr->At(i); if (!pV0) continue;
	pV0->GetControlVariables(d);
	BeforeV0Radius->Fill(d[ 0]);
        BeforeV0CosPA->Fill(d[ 1]);
        BeforeV0DistToPVoverP->Fill(d[ 2]);
        BeforeV0DausDCA->Fill(d[ 3]);
        BeforePosDCAtoPV->Fill(d[ 4]);
        BeforeNegDCAtoPV->Fill(d[ 5]);
        BeforeDauXrowsTPC->Fill(d[ 6]);
        BeforeDauXrowsOverFindableClusTPC->Fill(d[ 7]);
        BeforePosPionSigmaTPC->Fill(d[ 8]);
        BeforeNegPionSigmaTPC->Fill(d[ 9]);
        BeforePosProtonSigmaTPC->Fill(d[10]);
        BeforeNegProtonSigmaTPC->Fill(d[11]);
        BeforeV0Pt->Fill(d[12]);
        BeforeRapidityKa->Fill(d[13]);
        BeforeRapidityLa->Fill(d[14]);
        BeforeKshortMass->Fill(d[15]);
        BeforeLambdaMass->Fill(d[16]);
        BeforeAntiLaMass->Fill(d[17]);
        BeforePosEta->Fill(d[18]);
        BeforeNegEta->Fill(d[19]);
        if (!pV0->IsDausInEtaAcc(fV0CutMinDauEta,fV0CutMaxDauEta)) { pV0 = 0; continue; }
        if (fV0IsCutEta) { if (!pV0->IsV0InEtaAcc(fV0CutMinEta,fV0CutMaxEta)) { pV0 = 0; continue; } }
	  ...
	  hCountInW->Fill(dPt);
	  hPtEtaI->Fill(dPt, dEta); 
	  pV0->GetControlVariables(d);
	  AfterV0Radius->Fill(d[ 0]);
          AfterV0CosPA->Fill(d[ 1]);
          AfterV0DistToPVoverP->Fill(d[ 2]);
          AfterV0DausDCA->Fill(d[ 3]);
          AfterPosDCAtoPV->Fill(d[ 4]);
          AfterNegDCAtoPV->Fill(d[ 5]);
          AfterDauXrowsTPC->Fill(d[ 6]);
          AfterDauXrowsOverFindableClusTPC->Fill(d[ 7]);
          AfterPosPionSigmaTPC->Fill(d[ 8]);
          AfterNegPionSigmaTPC->Fill(d[ 9]);
          AfterPosProtonSigmaTPC->Fill(d[10]);
          AfterNegProtonSigmaTPC->Fill(d[11]);
          AfterV0Pt->Fill(d[12]);
          AfterRapidityKa->Fill(d[13]);
          AfterRapidityLa->Fill(d[14]);
          AfterKshortMass->Fill(d[15]);
          AfterLambdaMass->Fill(d[16]);
          AfterAntiLaMass->Fill(d[17]);
          AfterPosEta->Fill(d[18]);
          AfterNegEta->Fill(d[19]);
	}
...
//=============================================================================
    ...
    if((sOpt=="Xi") || (sOpt=="XiPos") || (sOpt=="XiNeg") || (sOpt=="Omega") || (sOpt=="OmegaPos") || (sOpt=="OmegaNeg")){
      ...
      for (Int_t i=0; i<nCascades; i++) {
        ...
        pCascade = (AliPicoCascadeRD*)fCascadesClArr->At(i); if (!pCascade) continue;
	pCascade->GetControlVariables(d);
        BeforeV0Radius->Fill(d[ 0]);
        BeforeV0CosPA->Fill(d[ 1]);
        BeforeV0DistToPVoverP->Fill(d[ 2]);
        BeforeV0DausDCA->Fill(d[ 3]);
        ...
        BeforePosEta->Fill(d[18]);
        BeforeNegEta->Fill(d[19]);
        BeforeXiRadius->Fill(d[20]);
        BeforeXiCosPA->Fill(d[21]);
        BeforeXiDCAtoPV->Fill(d[22]);
        BeforeV0DCAtoPV->Fill(d[23]);
        BeforeV0toBachDCA->Fill(d[24]);
        BeforeBachDCAtoPV->Fill(d[25]);
        BeforeBachXrowsTPC->Fill(d[26]);
        BeforeBachXrowsOverFindableClusTPC->Fill(d[27]);
        BeforeBachEta->Fill(d[28]);
        BeforeBachPiSigmaTPC->Fill(d[29]);
        BeforeBachKaSigmaTPC->Fill(d[30]);
        ...
        if  ((dInvM>dLowerS) && (dInvM<dUpperS))  {
	  hCountInW->Fill(dPt);
	  hPtEtaI->Fill(dPt, dEta);
	  ...
	  pCascade->GetControlVariables(d);
          ...
          AfterPosEta->Fill(d[18]);
          AfterNegEta->Fill(d[19]);
          AfterXiRadius->Fill(d[20]);
          AfterXiCosPA->Fill(d[21]);
          AfterXiDCAtoPV->Fill(d[22]);
          AfterV0DCAtoPV->Fill(d[23]);
          AfterV0toBachDCA->Fill(d[24]);
          AfterBachDCAtoPV->Fill(d[25]);
          AfterBachXrowsTPC->Fill(d[26]);
          AfterBachXrowsOverFindableClusTPC->Fill(d[27]);
          AfterBachEta->Fill(d[28]);
          AfterBachPiSigmaTPC->Fill(d[29]);
          AfterBachKaSigmaTPC->Fill(d[30]);
	}
...
void AliAnalysisTaskUserStraneJets::SetDefaultKaCutsPP()
{
   Double_t dCuts[] = {
    ...
    0.06,   // min neg DCA to PV
    70.,    // min dau Xrows TPC
    0.5,    // min dau Xrows / Findable Clus in TPC
    0.005,  // min delta comp mass
    3.      // max sigma PID in TPC
  };
