...
void Histo(){
  ...
  auto dEtaMin=0;
  auto dEtaMax=0;
  dEtaMin = hsXi->GetAxis(1)->FindBin(-0.75+1e-12);
  dEtaMax = hsXi->GetAxis(1)->FindBin(0.75-1e-12);
  
  auto hsKshort = (THnSparseD*)hsV0->Clone("hsKshort");
  //hsKshort->GetAxis(6)->SetRange(iCentMin, iCentMax);
  hsKshort->GetAxis(1)->SetRange(dEtaMin, dEtaMax);
  ...
  hsLambda->GetAxis(1)->SetRange(dEtaMin, dEtaMax);
  ...
  hsAntiLa->GetAxis(1)->SetRange(dEtaMin, dEtaMax);
  ...
  hXi->GetAxis(1)->SetRange(dEtaMin, dEtaMax);
  ...
  hsXiNeg->GetAxis(1)->SetRange(dEtaMin, dEtaMax);
  ...
  hsXiPos->GetAxis(1)->SetRange(dEtaMin, dEtaMax);
  ...
  hsOmega->GetAxis(1)->SetRange(dEtaMin, dEtaMax);
  ...
  hsOmegaNeg->GetAxis(1)->SetRange(dEtaMin, dEtaMax);
  ...
  hsOmegaPos->GetAxis(1)->SetRange(dEtaMin, dEtaMax);
