...
AliAnalysisTaskEmcalJetStrangeFilter *AddTaskEmcalJetStrangeFilter(
  ...
  const Bool_t bH = kTRUE)
{
  ...
  if (!mgr) {
    ::Error("AddTaskEmcalJetStrangeFilter::AddTaskEmcalJetStrangeFilter", "No analysis manager to connect to!!!");
     return NULL;
  }
//=============================================================================
  ...
  if (!pH) {
    ::Error("AddTaskEmcalJetStrangeFilter::AddTaskEmcalJetStrangeFilter", "This task requires an input event handler");
    return NULL;
  }
//=============================================================================
  ...
  if (wType==kUnknown) {
    ::Error("AddTaskEmcalJetStrangeFilter::AddTaskEmcalJetStrangeFilter", "Unkown data input");
    return NULL;
  }
//=============================================================================
...
//=============================================================================
  ...
  AliAnalysisTaskEmcalJetStrangeFilter *task = new AliAnalysisTaskEmcalJetStrangeFilter("AliAnalysisTaskEmcalJetStrangeFilter", bH);
...
//=============================================================================
  ...
  if (bH) mgr->ConnectOutput(task, 1, mgr->CreateContainer("listEMCalJet", AliEmcalList::Class(), AliAnalysisManager::kOutputContainer, AliAnalysisManager::GetCommonFileName()));
//=============================================================================
