...
void UEUncer(const TString sType = "Xi"){
  ...
  TString sPathOC08 = Form("/home/cuipengyao/study/pp/Local/ThisAna/Uncertainty/JE/UE/OC08"); 
  if(sType == "Omega")sPathOC08 = Form("/home/cuipengyao/study/pp/Local/ThisAna/Uncertainty/JE_Omega/UE/OC08"); 
  ...
  for(Int_t i = 1; i<=h1->GetNbinsX(); i++){
    ...
    h2->SetBinContent(i, TMath::Abs(V3-V2)/TMath::Sqrt(2.)); 
    h2->SetBinError(i, TMath::Sqrt(E3*E3 + E2*E2)/TMath::Sqrt(2.)); 
