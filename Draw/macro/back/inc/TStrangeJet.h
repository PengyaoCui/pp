...
//-------------------------------------------------------------
TH1D* GetOC08PtSpect(TString sType = "Kshort", TString Path = "/home/cuipengyao/study/pp/Local/ThisAna/Uncertainty/JE/UE/OC08"){
...
TH1D *GetOC08RatioLK()
{
  auto hK(GetOC08PtSpect("Kshort"));
  auto hL(GetOC08PtSpect("Lambda"));
  auto hA(GetOC08PtSpect("AntiLa"));
//=============================================================================
  hL->Add(hA);
...
//-------------------------------------------------------------
TH1D *GetOC08RatioOK(TString Path = "/home/cuipengyao/study/pp/Local/ThisAna/JE_OmegaBins")
{
  auto hK(GetOC08PtSpect("Kshort", Path));
  auto hO(GetOC08PtSpect("Omega", Path));
//=============================================================================
...
//-------------------------------------------------------------
TH1D *GetOC08RatioOL(TString Path = "/home/cuipengyao/study/pp/Local/ThisAna/JE_OmegaBins")
{
  auto hL(GetOC08PtSpect("Lambda", Path));
  auto hA(GetOC08PtSpect("AntiLa", Path));
  auto hO(GetOC08PtSpect("Omega", Path));
//=============================================================================
  hL->Add(hA);
...
//-------------------------------------------------------------
TH1D *GetOC08RatioOX(TString Path = "/home/cuipengyao/study/pp/Local/ThisAna/JE_OmegaBins")
{
  auto hX(GetOC08PtSpect("Xi", Path));
  auto hO(GetOC08PtSpect("Omega", Path));
//=============================================================================
