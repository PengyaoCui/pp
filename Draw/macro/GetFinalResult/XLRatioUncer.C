...
void XLRatioUncer(){
  ...
  ofstream OutFile;
  OutFile.open(Form("./dat/XLRatioUncer.dat"));
  OutFile<<left<<setw(15)<<"XLRatio"<<endl;
  ...
  tex->DrawLatex(0.15, 0.65, Form("#Xi/#Lambda"));
  leg->Draw();
  gStyle->SetOptStat("");
  can->SaveAs(Form("./figure/Uncert/XLRatio_JCUncert.pdf"));
  can->SaveAs(Form("./figure/Uncert/XLRatio_JCUncert.eps"));
