...
void PtSpect(TString sType = "OmegaPos"){
  ...
  Bool_t   IsOC(0);	
  Bool_t   IsNJ(0);	
  TString sPath = "/home/cuipengyao/study/pp/Local/Compare2LF/FullStat";
  ...
  if(IsJC){
    ...
    TFile *f = TFile::Open("./result/PtSpect_ThisAna_NewOmegaBin.root", "UPDATE");
