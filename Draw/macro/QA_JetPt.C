...
void QA_JetPt(){
  ...
  const TString sRatio = "16p as Ref";
  //TString sPathNu[] = {"18b", "18d", "18e", "18f", "18g", "18h", "18i", "18k", "18l", "18m", "18o"};
  //TString sPathNu[] = { "17c", "17e", "17f", "17g", "17h", "17i", "17j", "17k", "17l", "17m", "17o" , "17r"};
  TString sPathNu[] = { "16d", "16e", "16g", "16h", "16i", "16k", "16l", "16o"};
  //TString sPathNu[] = { "18", "17" };

  TString sPathDe = "/home/cuipengyao/study/pp/Local/QADiffPeriod/16p";
  //TString sFile = "AnalysisOutputs_FitCbinRD.root";
  //TString sList = "listFitCbinRD_Kshort_Default";
  //TString sHist = "hS";
  ...
  TString sLeg[] = { "LHC16d", "LHC16e", "LHC16g", "LHC16h", "LHC16i", "LHC16k", "LHC16l", "LHC16o", "LHC16p"};
  //Double_t nEvent[] = {677433787, 851296843, 489732981};
  Double_t nEvent[] = {1.96122e+07, 8.04088e+07, 3.11798e+07, 4.58912e+07, 4.09847e+07, 1.63015e+08, 3.58013e+07, 4.4378e+07, 2.84618e+07};

  TString sLatex(Form("16p as the referene"));
  Double_t XMin = 0.; 
  Double_t XMax = 12. ;
  Double_t YMin = 1e-9;
  Double_t YMax = 1e1;
  ...
  for (Int_t i = 0; i< nHist; ++i){
    ...
    SetFrame(hRatio, Form("#it{p}_{T, jet}"), sRatio, 0.08, 0.08, 0.1, 0.1, 1.10, 0.6);
  }
  ...
  tex->DrawLatex(0.2, 0.9, "#it{p}_{T, jet}");
  tex->DrawLatex(0.2, 0.8, sLatex);
  leg->Draw();
  gStyle->SetOptStat("");
  can->SaveAs(Form("./figure/QAPlots/Kshort_%s_16.eps", sHist.Data()));
  CanvasEnd(can);
  return;
}
