...
void Ratio(){
  ...
  const TString sRatio = "16l/ALICE";
  TString sPathNu[] = {"./result"};
  TString sFileNu[] = {"PtSpect_Eta.root"};
  TString sListNu[] = {""};
  ...
  TString sListDe = "";
  TString sHistDe = "hstat_xi_pp13_sum";
  //TString sPathDe = "./result_pp";
  //TString sFileDe = "PtSpect_Kshort.root";
  //TString sListDe = "";
  //TString sHistDe = "hPtJE_Kshort";

  TString sLeg[] = {"16l", "Alice"};
  ...
  leg->Draw();
  gStyle->SetOptStat("");
  //can->SaveAs(Form("./figure/KshortNegPostoKshort_%s%s_Corr.eps", CentMin.Data(), CentMax.Data()));
  CanvasEnd(can);
  return;
}
