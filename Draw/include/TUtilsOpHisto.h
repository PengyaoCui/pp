void ResetGraphName(TGraph *g, TH1 *h)
{
  TString newName  = TString::Format("grErr_%s",h->GetName());
  TString newTitle = TString::Format("grErr_%s",h->GetTitle());
  g->SetName(newName.Data());
  g->SetTitle(newTitle.Data());  
}
...
TGraphErrors* ConvHistogramToGraphErrors(TH1D *hVar, TH1D *hErr, const Int_t n, const Bool_t bSmall=kFALSE)
{
  ...
  ResetGraphName(g, hVar);
  return g;
}

//_____________________________________________________________________________
TGraphErrors* ConvHistogramToGraphErrorL(TH1D *hVar, TH1D *hErr, const Int_t n, const Bool_t bSmall=kFALSE)
{
  Double_t *dtm = new Double_t[n];
...
//_____________________________________________________________________________
TGraphErrors* ConvHistogramToGraphErrorR(TH1D *hVar, TH1D *hErr, const Int_t n, const Bool_t bSmall=kFALSE)
{
  Double_t *dtm = new Double_t[n];
